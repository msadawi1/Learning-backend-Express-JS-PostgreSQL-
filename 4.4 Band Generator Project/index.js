...
let date = new Date(); var year = date.getFullYear();
...
app.post("/submit", (req, res) => {
  ...
  let random_name = adj[Math.floor(adj.length * Math.random())] + " " + noun[Math.floor(adj.length * Math.random())] ;
  res.render("index.ejs", {bandName: random_name, currentYear: year});
});
