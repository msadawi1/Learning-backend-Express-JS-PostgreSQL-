...
app.get("/random", (req, res) => {
  ...
  res.status(404).json({
    error: `Error: there are no jokes.`
  });
});
...
app.get("/jokes/:id", (req, res) => {
  ...
  res.status(404).json({
    error: `Error: joke with id ${id} not found.`
  });
});
...
app.get("/filter", (req, res) => {
  ...
  res.status(404).json({
    error: `Error: no jokes found with this type.`
  });
});
...
app.put("/jokes/:id", (req, res) => {
  ...
  res.status(404).json({
    error: `Error: joke with id ${id} not found. No jokes replaced.`
  });
});
...
app.patch("/jokes/:id", (req, res) => {
  ...
  if (foundJoke) {
    foundJoke.jokeText = req.body.text || foundJoke.jokeText;
    foundJoke.jokeType = req.body.type || foundJoke.jokeType;
    res.json(foundJoke);
  }
  res.status(404).json({
    error: `Error: joke with id ${id} not found. No jokes modified.`
  });
});
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (index !== -1) {
    ...
    res.status(200).json({
      message: `Successfully deleted joke with id ${id}.`,
    });
  } 
  res.status(404).json({
    error: `Error: joke with id ${id} not found. No jokes deleted.`
  });
});
...
app.delete("/all", (req, res) => {
  ...
  if (key === masterKey) {
    jokes = [];
    res.status(200).json({
      message: `Successfully deleted all jokes.`,
    });
  }
  res.status(404).json({
